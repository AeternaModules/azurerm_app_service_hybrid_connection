output "app_service_hybrid_connections_id" {
  ...
  value       = { for k, v in azurerm_app_service_hybrid_connection.app_service_hybrid_connections : k => v.id if v.id != null && length(v.id) > 0 }
}
output "app_service_hybrid_connections_app_service_name" {
  ...
  value       = { for k, v in azurerm_app_service_hybrid_connection.app_service_hybrid_connections : k => v.app_service_name if v.app_service_name != null && length(v.app_service_name) > 0 }
}
output "app_service_hybrid_connections_hostname" {
  ...
  value       = { for k, v in azurerm_app_service_hybrid_connection.app_service_hybrid_connections : k => v.hostname if v.hostname != null && length(v.hostname) > 0 }
}
output "app_service_hybrid_connections_namespace_name" {
  ...
  value       = { for k, v in azurerm_app_service_hybrid_connection.app_service_hybrid_connections : k => v.namespace_name if v.namespace_name != null && length(v.namespace_name) > 0 }
}
output "app_service_hybrid_connections_port" {
  ...
  value       = { for k, v in azurerm_app_service_hybrid_connection.app_service_hybrid_connections : k => v.port if v.port != null }
}
output "app_service_hybrid_connections_relay_id" {
  ...
  value       = { for k, v in azurerm_app_service_hybrid_connection.app_service_hybrid_connections : k => v.relay_id if v.relay_id != null && length(v.relay_id) > 0 }
}
output "app_service_hybrid_connections_relay_name" {
  ...
  value       = { for k, v in azurerm_app_service_hybrid_connection.app_service_hybrid_connections : k => v.relay_name if v.relay_name != null && length(v.relay_name) > 0 }
}
output "app_service_hybrid_connections_resource_group_name" {
  ...
  value       = { for k, v in azurerm_app_service_hybrid_connection.app_service_hybrid_connections : k => v.resource_group_name if v.resource_group_name != null && length(v.resource_group_name) > 0 }
}
output "app_service_hybrid_connections_send_key_name" {
  ...
  value       = { for k, v in azurerm_app_service_hybrid_connection.app_service_hybrid_connections : k => v.send_key_name if v.send_key_name != null && length(v.send_key_name) > 0 }
}
output "app_service_hybrid_connections_send_key_value" {
  ...
  value       = { for k, v in azurerm_app_service_hybrid_connection.app_service_hybrid_connections : k => v.send_key_value if v.send_key_value != null && length(v.send_key_value) > 0 }
  sensitive   = true
}
output "app_service_hybrid_connections_service_bus_namespace" {
  ...
  value       = { for k, v in azurerm_app_service_hybrid_connection.app_service_hybrid_connections : k => v.service_bus_namespace if v.service_bus_namespace != null && length(v.service_bus_namespace) > 0 }
}
output "app_service_hybrid_connections_service_bus_suffix" {
  ...
  value       = { for k, v in azurerm_app_service_hybrid_connection.app_service_hybrid_connections : k => v.service_bus_suffix if v.service_bus_suffix != null && length(v.service_bus_suffix) > 0 }
}
